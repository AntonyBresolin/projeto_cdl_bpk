...
async function searchCourses() {
    try {
        var result = await fetch('https://8lq8do82.api.sanity.io/v2021-10-21/data/query/production?query=%0A*%5B_type+%3D%3D+%22cursos%22%5D%7C+order%28_updatedAt+desc%29%7B%0A++nome_curso%0A%7D&perspective=published', {
            method: 'get',
        })
