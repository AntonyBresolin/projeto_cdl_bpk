...
async function searchFaq() {
    ...
    try {
        var result = await fetch("https://0o8j5e3g.api.sanity.io/v2021-10-21/data/query/production?query=*%5B_type+%3D%3D+%22pergunta_frequente%22%5D%7B%0A++pergunta%2C+resposta%0A%7D", {
                method: 'get'
            });
